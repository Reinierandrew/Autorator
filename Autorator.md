...
1. A dataset of 8 million Yelp reviews was used. Restuarant reviews that had a user comment of useful and which had a specific origion of food e.g. Italian or Vietnamese.  The result was a dataset of 105.000 reviews which was used to train machine learning models. Originally this was done in an sql database though for ease of use a python script is included to extract the above **notebooks/extract_data.jpynb**  
